...
public class EditReview extends AppCompatActivity {
  ...
  //  ImageView prodsmallimg;
    ...
    private OnCompleteListener<DataSnapshot> onValuesFetched;
    String username;
    ...
    public void showReview() {
        ...
        ratingbar.setRating(userratinglong);
        reviewtv.setText(userreview);
    ...
    public void initializeAll() {
        ratingtv = findViewById(R.id.editratingText);
        reviewtv = findViewById(R.id.editreviewbox);
        productnametv = findViewById(R.id.editproductnamevw);
        ratingbar = findViewById(R.id.editratingBar);
        // checktv = findViewById(R.id.checktv);
     //   prodsmallimg = findViewById(R.id.editprodsmallimg);
        userreview = "";
        userrating = 0;
        ...
        onValuesFetched = new OnCompleteListener<DataSnapshot>() {
            @Override
            public void onComplete(@NonNull Task<DataSnapshot> task) {
                ...
                if (!task.isSuccessful()) {
                    ...
                    userreview = (String)task.getResult().child(productid).child(username).child("reviewtxt").getValue();
                    userratinglong = (long) task.getResult().child(productid).child(username).child("rating").getValue();
                    showReview();
        ...
        reviewRef.get().addOnCompleteListener(onValuesFetched);
    }
